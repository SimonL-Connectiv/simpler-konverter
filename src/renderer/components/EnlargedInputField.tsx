    ...
    >
      ...
      >
        <div className="flex items-center justify-between mb-4 pr-12">
          <h2 className="text-xl font-bold">{showTable ? 'CSV Tabelle' : format}</h2>
          <div className="flex items-center gap-2">
            {format === 'CSV' && (
              ...
              >
                {showTable ? <Code size={20} /> : <TableIcon size={20} />}
              </button>
            )}
        ...
        <div className="flex-1 overflow-hidden">
          {showTable && format === 'CSV' ? (
            ...
            <motion.div
              ...
              className="h-full"
            >
              <InputField format={format} hideActions disableSelect />
            </motion.div>
          )}
        </div>
      </motion.div>
